...
char temp4;
char parti_Ad[6]={'A','B','C','D','E','F'}; // Stabil parti dizisi.
char sirali_Parti[6]={'A','B','C','D','E','F'}; // Oy sayýlarýna göre her adýmda düzenli olarak sýralanan dizi.
char mv_Parti[6]={'A','B','C','D','E','F'}; // Milletvekili daðýlýmý esnasýnda üzerinde iþlem yapýlan dizi.
float yy[6]={0,0,0,0,0,0}; // Oy yüzdesi.
float yy_2[6]={0,0,0,0,0,0}; // Milletvekili yüzdesi.
int il_Kodu[5]={0,0,0,0,0}; // Ýl kodlarýnýn depolandýðý dizi.
float MV_Sayisi[6]={0,0,0,0,0,0}; 
float oy_Sayisi[6]={0,0,0,0,0,0}; // Her il için oy sayýlarýnýn en baþta depolandýðý dizi.
...
float mv_2[6]={0,0,0,0,0,0}; // Milletvekili daðýlýmý için geçici dizi.
